...
const API_URL = 'http://localhost:4000/out_of_court';// 'https://league-table.herokuapp.com';
...
class OutOfCourt extends Component {
    ...
    return (
      <div style={{ fontFamily: 'arial' }}>
        <Tabs onSelect={index => this.selectedTab(index)}>
          ...
          {tabs.map((result, key) => {
            const investmentByCases = results.filter(e => e.TAB === result && e.RANKTYPE === '"Financial Advisor to Distressed Company"');
